...
class AddressDesignMenu extends StatefulWidget {
  ...
  @override
  State<AddressDesignMenu> createState() => _AddressDesignMenuState();
}

class _AddressDesignMenuState extends State<AddressDesignMenu> {
  @override
