...
import 'package:arel_yemek/uploadScreens/items_upload_screen.dart';
import 'package:arel_yemek/uploadScreens/menus_upload_screen.dart';
import 'package:arel_yemek/widgets/info_design.dart';
import 'package:arel_yemek/widgets/items_design.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: CustomScrollView(
        slivers: [
          SliverPersistentHeader(pinned: true, delegate: TextWidgetHeader(title:  widget.model!.menuTitle.toString() + " Menüsü")),
